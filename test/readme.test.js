...
describe('README — V1.18 Supervisor lifecycle disabled runner registry readiness', () => {
  it('title and badge claim V1.18 as current', () => {
    assertReadmeContains(/# Linke V1\.18/, 'README title should mention V1.18');
    assertReadmeContains(/\*\*当前版本：V1\.18\*\*/, 'README badge should mention V1.18');
  ...
  it('version table marks V1.18 current and keeps V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.18 \| 当前版本 \|[^|]*buildSupervisorLifecycleGuardedRunnerRegistryReadiness[^|]*runnerRegistryReadiness\.state:blocked[^|]*runnerRegistryReady:false[^|]*runner-registry-real-implementation-missing[^|]*Gold 依旧 blocked/i, 'V1.18 should be current disabled runner registry readiness milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.18', () => {
  ...
  it('keeps later Gold readiness sections synced to V1.18 evidence', () => {
