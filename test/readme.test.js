...
describe('README — V1.15 Supervisor lifecycle guarded runner execution gate API', () => {
  it('title and badge claim V1.15 as current', () => {
    assertReadmeContains(/# Linke V1\.15/, 'README title should mention V1.15');
    assertReadmeContains(/\*\*当前版本：V1\.15\*\*/, 'README badge should mention V1.15');
  ...
  it('version table marks V1.15 current and keeps V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.15 \| 当前版本 \|[^|]*POST \/api\/supervisor-lifecycle-guarded-runner-execution-gate[^|]*inline[^|]*executeRequested[^|]*server-owned `?dataDir`?[^|]*API_WRITE_ROUTES[^|]*read token[^|]*test\/supervisor-lifecycle-guarded-runner-execution-gate-api\.test\.js[^|]*executionEligible:false[^|]*executeRequested:true[^|]*realRunnerWiringReady:false[^|]*real-guarded-runner-execution-wiring-missing/i, 'V1.15 should be current guarded runner execution gate API milestone');
  ...
  it('documents executor manifest readiness pure function and fail-closed boundaries', () => {
    ...
    assertReadmeContains(/POST \/api\/supervisor-lifecycle-guarded-runner-execution-gate/, 'README should document V1.15 execution gate API surface');
    ...
    assertReadmeContains(/executeRequested[\s\S]*(boolean|布尔)/i, 'README should document V1.15 executeRequested boolean contract');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.15', () => {
