...
describe('README — V1.12 Supervisor lifecycle guarded runner execution preview Web', () => {
  it('title and badge claim V1.12 as current', () => {
    assertReadmeContains(/# Linke V1\.12/, 'README title should mention V1.12');
    assertReadmeContains(/\*\*当前版本：V1\.12\*\*/, 'README badge should mention V1.12');
  ...
  it('version table marks V1.12 current and keeps V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.12 \| 当前版本 \|[^|]*supervisor-lifecycle-guarded-runner-execution-preview-button[^|]*buildSupervisorLifecycleGuardedRunnerExecutionPreviewViewModel[^|]*POST \/api\/supervisor-lifecycle-guarded-runner-execution-preview[^|]*executionReady:false[^|]*wouldExecute:false[^|]*test\/web-console\.test\.js supervisor lifecycle guarded runner execution preview/i, 'V1.12 should be current guarded runner execution preview Web milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.12', () => {
  ...
  it('keeps later Gold readiness sections synced to V1.12 evidence', () => {
    assertReadmeContains(/Agent CLI[\s\S]*?V1\.12[\s\S]*?supervisor-lifecycle-guarded-runner-execution-preview-button[\s\S]*?buildSupervisorLifecycleGuardedRunnerExecutionPreviewViewModel[\s\S]*?test\/web-console\.test\.js supervisor lifecycle guarded runner execution preview[\s\S]*?V1\.11[\s\S]*?POST \/api\/supervisor-lifecycle-guarded-runner-execution-preview[\s\S]*?test\/supervisor-lifecycle-guarded-runner-execution-preview-api\.test\.js[\s\S]*?V1\.10[\s\S]*?agent\.js supervisor-lifecycle-guarded-runner-execution-preview[\s\S]*?test\/agent-supervisor-lifecycle-guarded-runner-execution-preview\.test\.js[\s\S]*?V1\.09[\s\S]*?buildSupervisorLifecycleGuardedRunnerExecutionPreview[\s\S]*?test\/supervisor-lifecycle-guarded-runner-execution-preview\.test\.js/i, 'README Agent CLI Gold section should mention V1.12 Web evidence, V1.11 API evidence, V1.10 guarded runner execution preview CLI evidence and V1.09 pure evidence');
    ...
    assertReadmeContains(/Gold blockers[\s\S]*?V1\.12[\s\S]*?supervisor-lifecycle-guarded-runner-execution-preview-button[\s\S]*?buildSupervisorLifecycleGuardedRunnerExecutionPreviewViewModel[\s\S]*?test\/web-console\.test\.js supervisor lifecycle guarded runner execution preview[\s\S]*?V1\.11[\s\S]*?POST \/api\/supervisor-lifecycle-guarded-runner-execution-preview[\s\S]*?test\/supervisor-lifecycle-guarded-runner-execution-preview-api\.test\.js[\s\S]*?V1\.10[\s\S]*?agent\.js supervisor-lifecycle-guarded-runner-execution-preview[\s\S]*?test\/agent-supervisor-lifecycle-guarded-runner-execution-preview\.test\.js[\s\S]*?V1\.09[\s\S]*?buildSupervisorLifecycleGuardedRunnerExecutionPreview[\s\S]*?guarded-runner-execution-preview-only[\s\S]*?real-guarded-runner-execution-wiring-missing[\s\S]*?test\/supervisor-lifecycle-guarded-runner-execution-preview\.test\.js/i, 'README Gold blockers section should mention V1.12 Web evidence, V1.11 API evidence, V1.10 CLI evidence and V1.09 pure evidence');
    ...
    assertReadmeContains(/NAS、认证和生产硬化仍是 partial[\s\S]*?V1\.12[\s\S]*?supervisor-lifecycle-guarded-runner-execution-preview-button[\s\S]*?V1\.11[\s\S]*?POST \/api\/supervisor-lifecycle-guarded-runner-execution-preview[\s\S]*?V1\.10[\s\S]*?agent\.js supervisor-lifecycle-guarded-runner-execution-preview[\s\S]*?V1\.09[\s\S]*?buildSupervisorLifecycleGuardedRunnerExecutionPreview[\s\S]*?V1\.08[\s\S]*?supervisor-lifecycle-guarded-runner-readiness-button[\s\S]*?V1\.07[\s\S]*?POST \/api\/supervisor-lifecycle-guarded-runner-readiness[\s\S]*?V1\.06[\s\S]*?src\/agent\.js supervisor-lifecycle-guarded-runner-readiness[\s\S]*?V1\.05[\s\S]*?buildSupervisorLifecycleGuardedRunnerReadiness[\s\S]*?V1\.04[\s\S]*?supervisor-lifecycle-executor-manifest-readiness-button[\s\S]*?V1\.03[\s\S]*?POST \/api\/supervisor-lifecycle-executor-manifest-readiness/i, 'README partial hardening section should mention V1.12 Web evidence, V1.11 API evidence, V1.10 CLI evidence, V1.09 pure preview evidence, V1.08 Web evidence, V1.07 API evidence, V1.06 CLI evidence, retain V1.05 runner evidence, V1.04 manifest Web evidence and V1.03 API evidence');
  });
});
