...
describe('README — V1.25 Supervisor lifecycle real runner registry', () => {
  it('title and badge claim V1.25 as current', () => {
    assertReadmeContains(/# Linke V1\.25/, 'README title should mention V1.25');
    assertReadmeContains(/\*\*当前版本：V1\.25\*\*/, 'README badge should mention V1.25');
  ...
  it('version table marks V1.25 current and keeps V1.24/V1.23/V1.22/V1.21/V1.20/V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.25 \| 当前版本 \|[^|]*resolveSupervisorLifecycleGuardedRunnerRegistry[^|]*runnerRegistryReadiness\.state:ready[^|]*runnerRegistryReady:true[^|]*codeOwnedRegistryResolverReady:true[^|]*realRunnerImplementationsReady:false[^|]*readyCount:2[^|]*blockedCount:4[^|]*registryDecision[^|]*executionEligible:false[^|]*Gold 依旧 blocked/i, 'V1.25 should be current real runner registry milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.25', () => {
