...
describe('README — V1.16 Supervisor lifecycle guarded runner execution gate Web Console', () => {
  it('title and badge claim V1.16 as current', () => {
    assertReadmeContains(/# Linke V1\.16/, 'README title should mention V1.16');
    assertReadmeContains(/\*\*当前版本：V1\.16\*\*/, 'README badge should mention V1.16');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.16', () => {
