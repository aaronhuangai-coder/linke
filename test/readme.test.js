...
describe('README — V1.21 Supervisor lifecycle disabled attempt audit readiness', () => {
  it('title and badge claim V1.21 as current', () => {
    assertReadmeContains(/# Linke V1\.21/, 'README title should mention V1.21');
    assertReadmeContains(/\*\*当前版本：V1\.21\*\*/, 'README badge should mention V1.21');
  ...
  it('version table marks V1.21 current and keeps V1.20/V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.21 \| 当前版本 \|[^|]*buildSupervisorLifecycleGuardedRunnerAttemptAuditReadiness[^|]*attemptAuditReadiness\.state:blocked[^|]*attemptAuditReady:false[^|]*attempt-audit-real-implementation-missing[^|]*Gold 依旧 blocked/i, 'V1.21 should be current disabled attempt audit readiness milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.21', () => {
  ...
  it('keeps later Gold readiness sections synced to V1.21 evidence', () => {
