...
describe('README — V1.14 Supervisor lifecycle guarded runner execution gate CLI', () => {
  it('title and badge claim V1.14 as current', () => {
    assertReadmeContains(/# Linke V1\.14/, 'README title should mention V1.14');
    assertReadmeContains(/\*\*当前版本：V1\.14\*\*/, 'README badge should mention V1.14');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.14', () => {
