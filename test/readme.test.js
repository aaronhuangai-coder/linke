...
describe('README — V1.17 Supervisor lifecycle guarded runner wiring contract', () => {
  it('title and badge claim V1.17 as current', () => {
    assertReadmeContains(/# Linke V1\.17/, 'README title should mention V1.17');
    assertReadmeContains(/\*\*当前版本：V1\.17\*\*/, 'README badge should mention V1.17');
  ...
  it('version table marks V1.17 current and keeps V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.17 \| 当前版本 \|[^|]*buildSupervisorLifecycleGuardedRunnerWiringContract[^|]*runnerWiringContract[^|]*runnerWiringContractReady:false[^|]*requiredContracts[^|]*real-guarded-runner-execution-wiring-missing/i, 'V1.17 should be current guarded runner wiring contract milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.17', () => {
