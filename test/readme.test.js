...
describe('README — V1.27 Supervisor lifecycle rollback anchor', () => {
  it('title and badge claim V1.27 as current', () => {
    assertReadmeContains(/# Linke V1\.27/, 'README title should mention V1.27');
    assertReadmeContains(/\*\*当前版本：V1\.27\*\*/, 'README badge should mention V1.27');
  ...
  it('version table marks V1.27 current and keeps V1.26/V1.25/V1.24/V1.23/V1.22/V1.21/V1.20/V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.27 \| 当前版本 \|[^|]*resolveSupervisorLifecycleGuardedRunnerRollbackAnchor[^|]*rollbackAnchorReadiness\.state:ready[^|]*rollbackAnchorReady:true[^|]*codeOwnedAnchorResolverReady:true[^|]*realRollbackAnchorImplementationReady:false[^|]*readyCount:4[^|]*blockedCount:2[^|]*anchorDecision[^|]*executionEligible:false[^|]*Gold 依旧 blocked/i, 'V1.27 should be current rollback anchor milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.27', () => {
