...
describe('README — V1.23 Supervisor lifecycle disabled execution policy readiness', () => {
  it('title and badge claim V1.23 as current', () => {
    assertReadmeContains(/# Linke V1\.23/, 'README title should mention V1.23');
    assertReadmeContains(/\*\*当前版本：V1\.23\*\*/, 'README badge should mention V1.23');
  ...
  it('version table marks V1.23 current and keeps V1.22/V1.21/V1.20/V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.23 \| 当前版本 \|[^|]*buildSupervisorLifecycleGuardedRunnerExecutionPolicyReadiness[^|]*executionPolicyReadiness\.state:blocked[^|]*executionPolicyReady:false[^|]*execution-policy-real-implementation-missing[^|]*Gold 依旧 blocked/i, 'V1.23 should be current disabled execution policy readiness milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.23', () => {
  ...
  it('keeps later Gold readiness sections synced to V1.23 evidence', () => {
