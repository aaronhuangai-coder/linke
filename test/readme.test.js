...
describe('README — V1.22 Supervisor lifecycle disabled operator recovery readiness', () => {
  it('title and badge claim V1.22 as current', () => {
    assertReadmeContains(/# Linke V1\.22/, 'README title should mention V1.22');
    assertReadmeContains(/\*\*当前版本：V1\.22\*\*/, 'README badge should mention V1.22');
  ...
  it('version table marks V1.22 current and keeps V1.21/V1.20/V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.22 \| 当前版本 \|[^|]*buildSupervisorLifecycleGuardedRunnerOperatorRecoveryReadiness[^|]*operatorRecoveryReadiness\.state:blocked[^|]*operatorRecoveryReady:false[^|]*operator-recovery-real-implementation-missing[^|]*Gold 依旧 blocked/i, 'V1.22 should be current disabled operator recovery readiness milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.22', () => {
  ...
  it('keeps later Gold readiness sections synced to V1.22 evidence', () => {
