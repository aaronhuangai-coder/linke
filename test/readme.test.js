...
describe('README — V1.20 Supervisor lifecycle disabled rollback anchor readiness', () => {
  it('title and badge claim V1.20 as current', () => {
    assertReadmeContains(/# Linke V1\.20/, 'README title should mention V1.20');
    assertReadmeContains(/\*\*当前版本：V1\.20\*\*/, 'README badge should mention V1.20');
  ...
  it('version table marks V1.20 current and keeps V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.20 \| 当前版本 \|[^|]*buildSupervisorLifecycleGuardedRunnerRollbackAnchorReadiness[^|]*rollbackAnchorReadiness\.state:blocked[^|]*rollbackAnchorReady:false[^|]*rollback-anchor-real-implementation-missing[^|]*Gold 依旧 blocked/i, 'V1.20 should be current disabled rollback anchor readiness milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.20', () => {
  ...
  it('keeps later Gold readiness sections synced to V1.20 evidence', () => {
