...
describe('README — V1.26 Supervisor lifecycle host mutation adapter', () => {
  it('title and badge claim V1.26 as current', () => {
    assertReadmeContains(/# Linke V1\.26/, 'README title should mention V1.26');
    assertReadmeContains(/\*\*当前版本：V1\.26\*\*/, 'README badge should mention V1.26');
  ...
  it('version table marks V1.26 current and keeps V1.25/V1.24/V1.23/V1.22/V1.21/V1.20/V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.26 \| 当前版本 \|[^|]*resolveSupervisorLifecycleGuardedRunnerHostMutationAdapter[^|]*hostMutationAdapterReadiness\.state:ready[^|]*hostMutationAdapterReady:true[^|]*codeOwnedAdapterResolverReady:true[^|]*realHostMutationImplementationReady:false[^|]*readyCount:3[^|]*blockedCount:3[^|]*adapterDecision[^|]*executionEligible:false[^|]*Gold 依旧 blocked/i, 'V1.26 should be current host mutation adapter milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.26', () => {
