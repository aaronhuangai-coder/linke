...
describe('README — V1.24 Supervisor lifecycle fail-closed execution policy', () => {
  it('title and badge claim V1.24 as current', () => {
    assertReadmeContains(/# Linke V1\.24/, 'README title should mention V1.24');
    assertReadmeContains(/\*\*当前版本：V1\.24\*\*/, 'README badge should mention V1.24');
  ...
  it('version table marks V1.24 current and keeps V1.23/V1.22/V1.21/V1.20/V1.19/V1.18/V1.17/V1.16/V1.15/V1.14/V1.13/V1.12/V1.11/V1.10/V1.09 historical', () => {
    assertReadmeContains(/\| V1\.24 \| 当前版本 \|[^|]*evaluateSupervisorLifecycleGuardedRunnerExecutionPolicy[^|]*areSupervisorLifecycleGuardedRunnerActionCandidatesReady[^|]*executionPolicyReadiness\.state:ready[^|]*executionPolicyReady:true[^|]*fail-closed-execution-policy[^|]*policyDecision[^|]*executionEligible:false[^|]*Gold 依旧 blocked/i, 'V1.24 should be current fail-closed execution policy milestone');
  ...
  it('keeps Gold blocked and rejects lifecycle overclaims for V1.24', () => {
