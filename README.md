...
> **当前版本：V0.43** — 单机 localhost 原型阶段，尚未具备生产级安全隔离。
...
| V0.43 | 当前版本 | 设备筛选摘要状态：设备筛选摘要增加只读 data-active 状态与 aria-atomic 可访问性支持 |
