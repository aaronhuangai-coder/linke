...
> **当前版本：V0.44** — 单机 localhost 原型阶段，尚未具备生产级安全隔离。
...
| V0.44 | 当前版本 | 设备筛选计数状态：设备筛选计数增加只读 data-filtered 属性以指示列表是否被过滤收窄 |
